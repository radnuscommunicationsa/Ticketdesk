    ...
    if (!$category || !$priority || !$subject || !$description) {
        ...
        if (!empty($_FILES['attachment']['name'])) {
            ...
            if ($file['error'] !== UPLOAD_ERR_OK) {
                ...
                $error = 'File type not allowed. Allowed: JPG, PNG, PDF, DOC, XLSX, ZIP.';
            } else {
        ...
        <form method="POST" enctype="multipart/form-data">
          <div class="form-grid">
            ...
            <div class="form-group full">
              ...
              <textarea name="description" placeholder="Describe in detail: what happened, when it started, any error messages..." style="min-height:130px" required></textarea>
            </div>
            <div class="form-group">
              <label>Asset / Device (optional)</label>
              <input type="text" name="asset" placeholder="e.g. Dell Laptop-HR-042"/>
            </div>
            <div class="form-group">
