...
// Helper function for admin URLs
function adminUrl($page = '') {
    return SITE_URL . '/admin/' . ltrim($page, '/');
}
...
<div class="sidebar">
  ...
  <div class="side-section">
    ...
    <a href="<?= adminUrl('dashboard.php') ?>" class="side-item <?= $current_page==='dashboard.php'?'active':'' ?>">
      <span class="side-icon"><i class="fa-solid fa-gauge-high"></i></span> Dashboard
    </a>
    <a href="<?= adminUrl('tickets.php') ?>" class="side-item <?= $current_page==='tickets.php'?'active':'' ?>">
      <span class="side-icon"><i class="fa-solid fa-ticket"></i></span> All Tickets
      <span class="side-badge"><?= $total_count ?></span>
    </a>
    <a href="<?= adminUrl('employees.php') ?>" class="side-item <?= $current_page==='employees.php'?'active':'' ?>">
      <span class="side-icon"><i class="fa-solid fa-users"></i></span> Employees
      <span class="side-badge"><?= $emp_count ?></span>
    </a>
    <a href="<?= adminUrl('assets.php') ?>" class="side-item <?= str_starts_with($current_page, 'asset')?'active':'' ?>">
  ...
  <div class="side-section">
    ...
    <a href="<?= adminUrl('reports.php') ?>" class="side-item <?= $current_page==='reports.php'?'active':'' ?>">
      <span class="side-icon"><i class="fa-solid fa-chart-bar"></i></span> Monthly Report
    </a>
    <a href="<?= adminUrl('admin_notifications.php') ?>" class="side-item <?= $current_page==='admin_notifications.php'?'active':'' ?>">
  ...
  <div class="side-section">
    ...
    <a href="<?= adminUrl('tickets.php?priority=critical') ?>" class="side-item">
    ...
    <a href="<?= adminUrl('tickets.php?status=in-progress') ?>" class="side-item">
    ...
    <a href="<?= adminUrl('tickets.php?status=open') ?>" class="side-item">
    ...
    <a href="<?= adminUrl('tickets.php?status=resolved') ?>" class="side-item">
