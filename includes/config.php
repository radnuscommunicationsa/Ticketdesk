...
define('DB_HOST', 'ballast.proxy.rlwy.net'); // Railway public host
define('DB_USER', 'root');
define('DB_PASS', 'YOUR_DATABASE_PASSWORD'); // Put your Railway DB password
define('DB_NAME', 'railway');
define('DB_PORT', '54272');

// ===============================
// Website URL
// ===============================

define('SITE_URL', 'https://your-project-name.up.railway.app');
...
try {
    ...
    die('<div style="font-family:sans-serif;padding:40px;background:#1a1a2e;color:#ef9a9a;text-align:center">
        ...
        <p style="color:#90a4ae;font-size:14px">Check your database settings.</p>
    </div>');
...
function logTicketAction($pdo, $ticketId, $action, $doneBy, $note = '') {
    $stmt = $pdo->prepare("INSERT INTO ticket_logs (ticket_id, action, done_by, note) VALUES (?, ?, ?, ?)");
    $stmt->execute([$ticketId, $action, $doneBy, $note]);
}
